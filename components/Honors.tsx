...
export default function Honors() {
    ...
    const honors = [
        ...
        },
        {
            ...
            description: 
            ['Qualified for the VEX Robotics State Championship in 2019 and 2022', 
            'Won as state finalists and qualified for the World Championship' 
            ],
            imageUrl: '/VEXRobotics.jpeg',
        },
        {
            ...
            date: '2020',
            description: 
            ['Received the school STEAM award for excellence in its fields' 
            ],
            imageUrl: '/CalabasasHS.jpeg',
        },
        {
